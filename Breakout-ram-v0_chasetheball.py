...
for episode in range(EPISODES):
    ...
    state_continuos = env.reset()[MEM_ADDR].astype(int)
    state = get_discrete(np.append(state_continuos, [left_right]))
    ...
    while not done:
        ...
        new_state_continuos = new_state_continuos[MEM_ADDR].astype(int)
        ...
        new_state = get_discrete(np.append(new_state_continuos, [left_right]))
        # print(new_state[0] - new_state[1], new_state[0], new_state[1])
