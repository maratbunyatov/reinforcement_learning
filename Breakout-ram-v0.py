...
MEM_ADDR = [70,99,101] #[70,99,] #[70,72,90,99,101,105]
...
for episode in range(EPISODES):
    ...
    state = np.append(get_discrete(state_continuos), [0])
    ...
    while not done:
        ...
        new_state_continuos, reward, done, _ = env.step(action)
        ...
        new_state = np.append(get_discrete(new_state_continuos), [up_down])
